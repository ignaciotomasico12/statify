            ...
            <Theme>
              <div className="fixed left-0 top-0 -z-10 h-screen w-screen">
                <div className="relative h-full w-full dark:bg-[#000000] bg-[#ffffff]">
                  ...
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-auto w-full aspect-square min-w-[400px] sm:min-w-[600px] md:min-w-[800px] rounded-full"></div>
                </div>
              </div>
              <div className="relative">
                <Header />
                <main className="px-3 sm:px-5 md:px-20 lg:px-32 xl:px-40 py-3 sm:py-5">
                  {children}
                </main>
                <Toaster />
              </div>
